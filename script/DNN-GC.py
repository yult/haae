...
if __name__ == "__main__":
    ## static graphic and course RandomOverSampler
    ## train
    import os
    from config_loader import get_data_dir

    data_dir = get_data_dir()
    dictionary_filename = os.path.join(data_dir, 'sample/graphic_course_dict.csv')
    ...
    output_dir = os.path.join(data_dir, 'output/output_dnn_gc')
